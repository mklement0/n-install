...
kSHA256_SUMS=(
  "b190ca0f0ed4f05e4efeb4367d520f090cbbe774b18be4e6f0d53403bdb0d50e  $kUPDATE_SCRIPT"
  "d2ff6cfff920be08d39a3e9bab44e64ccee33ee91abbed927b4440c2f0036ecd  $kUNINSTALL_SCRIPT"
)
##
...
modifyShellInitFile() {
  ...
  if [[ -n $INSTALL_N_TEST_OVERRIDE_SHELL_INIT_FILE ]]; then # override for testing
    ...
    case "$(basename -- "$SHELL")" in
      'bash')
        # !! Sadly, bash ONLY reads ~/.bash_profile in LOGIN shells, and on macOS (Darwin) ALL shells are login shells, so on OSX we must target ~/.bash_profile.
